  ...
  connectedCallback() {
    ...
    const render = () => {
      ...
      renderObjects(
        ctx,
        r,
        p.layout.exit.groups,
        p.layout.enter.groups,
        p.layout.update.groups,
        renderGroup,
        interpolateGroup
      )
      renderObjects(
      ...
      if (this.enableLinkEvents) {
        renderObjects(
          ...
          r,
          p.layout.exit.edges,
          p.layout.enter.edges,
          p.layout.update.edges,
          renderEdgeRegion,
          interpolateEdge
        )
      }
      ...
      renderObjects(
        ctx,
        r,
        p.layout.exit.vertices,
        p.layout.enter.vertices,
        p.layout.update.vertices,
        renderVertex,
        interpolateVertex
      )
      renderObjects(
