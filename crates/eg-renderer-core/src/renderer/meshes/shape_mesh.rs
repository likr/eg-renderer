...
pub fn insert_instance_item<T: ShapeData>(
    ...
    data.push(a0);
    data.push(a1);
    data.push(current.fill_color_r() / 255.);
    data.push(current.fill_color_g() / 255.);
    data.push(current.fill_color_b() / 255.);
    data.push(current.fill_color_opacity());
    data.push(next.fill_color_r() / 255.);
    data.push(next.fill_color_g() / 255.);
    data.push(next.fill_color_b() / 255.);
    ...
    data.push(current.stroke_color_r() / 255.);
    data.push(current.stroke_color_g() / 255.);
    data.push(current.stroke_color_b() / 255.);
    data.push(current.stroke_color_opacity());
    data.push(next.stroke_color_r() / 255.);
    data.push(next.stroke_color_g() / 255.);
    data.push(next.stroke_color_b() / 255.);
